...
function tradeCommodity(trade) {
  ...
  /**
   * @param {org.example.mynetwork.TradePartOfAsset} tradePortion
   * @transaction
   */ 
  function tradePortionOfAsset(tradePortion){
    let owners = tradePortion.commodity.owners
    ...
    const newOwnerConcept = factory.newConcept('org.example.mynetwork', 'Owner')
